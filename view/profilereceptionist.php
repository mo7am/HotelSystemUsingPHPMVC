      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h2 id="in"> Personal Information </h2> 
                   <hr class="in2">
                  <div id="prof">
                      <form  method="post" name="FirstForm" action="../controller/Updatereceptprofilecontroller.php">
                    <div  id="proff"> 
                       
                        <label style="font-size: 20px" for="Firstname"  class="top">First Name: </label>  
                       
                        <input value=" <?php if(isset($_SESSION['fname'])){
                      echo $_SESSION['fname']; 
                      }
                      ?>" type="text" name="FirstName"id="Firstname" title="please enter your First name" placeholder="First Name" required class="Input" pattern="[A-Za-z]{3,}">
                        
                       <label style="font-size: 20px" for="Lastname" class="top" >Last Name :  </label>  
                       <input value=" <?php if(isset($_SESSION['lname'])){
                      echo $_SESSION['lname']; 
                      }
                      ?>"  type="text" id="Lastname" name="Lastname" placeholder="Last Name" title="please enter your Last name"  required class="Input" pattern="[A-Za-z ]{3,}">
                        
                        <label style="font-size: 20px"class="top" for="Email" >Email : </label>  
                        <input value=" <?php if(isset($_SESSION['username'])){
                      echo $_SESSION['username']; 
                      }
                      ?>" type="email" id="Email" name="Email"placeholder="Email"  required class="Input" pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"  title="please enter email">
                    
                           <label style="font-size: 20px" for="pass" class="top">Password : </label>  
                           <input value=" <?php if(isset($_SESSION['password'])){
                      echo $_SESSION['password']; 
                      }
                      ?>" name="password" required type="text" autofocus required class="Input" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="pass" placeholder="password to you" class="Input" title="should be at least one number, one lowercase and one uppercase letter
    and  at least 8 characters">
                        
                     
                        <label style="font-size: 20px" for="Firstname"  class="top">Ssn: </label>  
                        <p style="color:white" value=" " type="text" name="city"id="Firstname" title="please enter your City" placeholder="City" autofocus required class="Input" pattern="{14}">
                      ...
                      ?>
                        ...
                        <p style="color:white" value=" " type="text" name="nationality"id="Firstname" title="please enter your Nationality" placeholder="Nationality" autofocus required class="Input" pattern="[A-Za-z]{2,10}">
                      ...
                      ?>
                        ...
                        <input value=" <?php if(isset($_SESSION['age'])){
                      echo $_SESSION['age']; 
                      }
                      ?>" type="text" name="Age"id="Firstname" title="please enter your Nationality" placeholder="Nationality" autofocus required class="Input" pattern="{2,10}">
                     
                         <label style="font-size: 20px" class="top"for="BD" >Birth date : </label>  
                         <input value="<?php if(isset($_SESSION['bitrhdate'])){
                      echo $_SESSION['bitrhdate']; 
                      }
                      ?>" name="Birthdate" type="date" id="BD" autofocus required class="Input" class="Input" placeholder="yyyy-mm-dd" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" >
                  
                       <label style="font-size: 20px" for="Firstname"  class="top">Work Hours: </label>  
                        <p style="color:white" value=" " type="text" name="nationality"id="Firstname" title="please enter your Nationality" placeholder="Nationality" autofocus required class="Input" pattern="{2,10}">
                     <?php if(isset($_SESSION['workhours'])){
                      ...
                      ?>
                        ...
                        <hr class="in3">  
                         <div>
                             <input id="info" type="submit" name="submit" value="Update">		
                      </div>
                             </form>
