          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h2 id="in"> Personal Information </h2> 
                   <hr class="in2">
                  <div id="prof">
                      <form  method="post" name="FirstForm" action="../controller/Updatehousekeepingcontroller.php">
                    <div  id="proff"> 
                      ...
                      ?>" type="text" name="FirstName"id="Firstname" title="please enter your First name" placeholder="First Name" required class="Input">
