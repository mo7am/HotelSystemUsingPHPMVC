          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                      ...
                      <h2 id="sen" style="margin-left:220px;"> Regist Room </h2>
         <hr class="dd">
         <form id="tab" action="../controller/registroomcontroller.php" method="post">
<br><label id="eee" style="color:blue" >  <?php if(isset($_SESSION['F&Lname'])){
                      echo $_SESSION['F&Lname']; 
                      }
                      ?> : Please Select Room Type </label></br></br>
