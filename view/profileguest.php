...
<html lang="en">
  ...
  $result = $object->query($query);
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="../view/sendmessage.php">Receptionist</a></li>
                          <li><a  href="../view/sendmessage.php">Service</a></li>
                          <li><a  href="../view/sendmessage.php">Guest</a></li>
                      </ul>
                  </li>
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h2 id="in"> Personal Information </h2> 
                   <hr class="in2">
                  <div id="prof">
                      <form  method="post" name="FirstForm" action="../controller/Updatecontroller.php">
                    <div  id="proff"> 
    ...
    and  at least 8 characters">
                        ...
                        <input value=" <?php if(isset($_SESSION['city'])){
                      echo $_SESSION['city']; 
                      }
                      ?>" type="text" name="city"id="Firstname" title="please enter your City" placeholder="City" autofocus required class="Input" pattern="[A-Za-z]{3,10}">
                        
                        
                        <label style="font-size: 20px" for="Firstname"  class="top">Nationality: </label>  
                        <input value=" <?php if(isset($_SESSION['nationality'])){
                      echo $_SESSION['nationality']; 
                      }
                      ?>" type="text" name="nationality"id="Firstname" title="please enter your Nationality" placeholder="Nationality" autofocus required class="Input" pattern="[A-Za-z]{2,10}">
