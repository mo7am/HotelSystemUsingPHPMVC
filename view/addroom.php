                 ...
                 echo ' </li>';
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            <form action="../controller/messagereceptcontroller.php.php" method="post">                          
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <form method="post" action="../controller/mtomreceptcontroller.php">
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                      ...
                      <h2 id="sen" style="margin-left:220px;"> Regist Room To Guest </h2>
         <hr class="dd">
         <form id="tab" action="../controller/addroomcontroller.php" method="post">
             <br><label id="eee" style="color:blue" > Username : <input class="la" value="<?php if(isset($_SESSION['usernamee'])){
                      echo $_SESSION['usernamee']; 
                      }
                      ?>" type="text" name="user" placeholder="Username"/> </label></br></br>
 <label style="font-size: 18px;margin-left: 20px" for="Gender" class="top"> Room Type : </label>  
                         
                       <label style="font-size: 20px" for="si"class="topAd" > Single </label>
                       <input type="radio" id="ma"  class="radio2" name="room" value="Single">
                        
                        <label style="font-size: 20px" for="do" class="topAdw"> Double </label>
                        <input type="radio" class="radio2" name="room" id="fa" value="Double">
                        
                        <label style="font-size: 20px" for="su" class="topAdw"> Suite </label>
                        <input type="radio" class="radio2" name="room" id="fa" value="Suite"><br></br><br>
                        
                        <label style="font-size: 20px;margin-left: 20px" class="top"for="BD" >Check in : </label>  
                        <input  style="width:400px" name="checkin" type="date" id="BD" autofocus required class="Input" class="Input" placeholder="yyyy-mm-dd" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" >
                  
                        <label style="font-size: 20px;margin-left: 20px" class="top"for="BD" >Check out : </label>  
                        <input  style="width:400px" name="checkout" type="date" id="BD" autofocus required class="Input" class="Input" placeholder="yyyy-mm-dd" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" >
