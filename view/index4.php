...
<html lang="en">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <p class="green">You have <?php
                                 $guest1 = new guest();
                                 $user1 = new User();
                                 $idsender2 = $guest1->get_id_of_user($_SESSION['username']);
       
                                 $num1 =  $user1->numofmessage($idsender2);
  ...
  $query = "SELECT * FROM `message` WHERE receiver_id = '$idsender' AND state_id = '4'";
      ...
      *********************************************************************************************************************************************************** -->                  
      ...
      <footer class="site-footer">
          <div class="text-center">
              2017 - Mohamed Salah
              <a href="index4.php#" class="go-top">
