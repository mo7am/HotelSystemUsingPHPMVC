          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                      ...
                      <h2 id="sen" style="margin-left:220px;"> Replay To This Message</h2>
         <hr class="dd">
         <form id="tab" action="../controller/replayreceptcontrol.php" method="post">
             <br><label id="eee" > Username: <P class="la" type="text" name="user" placeholder="Username">
                 <?php if(isset($_SESSION['usernamesender'])){
