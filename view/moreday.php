          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                      ...
                      <h2 id="sen" style="margin-left:220px;"> Add More Day To Guest</h2>
         <hr class="dd">
         <form style="width:700px ;margin-left: 70px" id="tab" action="../controller/moredaycontroller.php" method="post">
<br><label id="eee" > Username: <input class="la" type="text" name="user" placeholder="Username"/></label></br></br>
 <label style="font-size: 20px ;padding-left: 30px" class="top"for="BD" >Check out : </label> 
 <div style=" padding-left: 110px"> 
 <input  name="checkout" type="date" id="BD" autofocus required class="Input" class="Input" placeholder="yyyy-mm-dd" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" >
 </div>              <br><br>
<input style="color:black " class="se" name="submit" type="submit" value="Add"/>
