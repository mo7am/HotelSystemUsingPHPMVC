          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                  	...
                  	<h2 style="margin-left:180px " id="in"> Search About Actor Information </h2> 
                   <hr class="in2">
                  <div id="prof">
                      <form  method="post" name="FirstForm" action="../controller/searchstaffcontroller.php" onsubmit="alert('Thanks for Searching');">
                    <div  id="proff"> 
                       
                        <label id="eee" > Username: <input name="userstaff" class="la" type="text"  placeholder="Username"/></label>
                        <br>
                        ...
                        <input style="color: black" value="<?php if(isset($_SESSION['fname1'])){
                      echo $_SESSION['fname1']; 
                      }
                      ?>" type="text" name="FirstName"id="Firstname" placeholder="First Name"  class="Input" pattern="[A-Za-z]{2,10}">
                       
                        
                       <label style="font-size: 20px" for="Lastname" class="top" >Last Name :  </label>  
                       <input style="color: black" value="<?php if(isset($_SESSION['lname1'])){
                      echo $_SESSION['lname1']; 
                      }
                      ?>" type="text" id="Lastname" name="Lastname" placeholder="Last Name" title="please enter your Last name"   class="Input" pattern="[A-Za-z ]{3,}">
                       
                       
                        <label style="font-size: 20px"class="top" for="Email" >Email : </label>  
                        <input style="color: black" value="<?php if(isset($_SESSION['username1'])){
                      echo $_SESSION['username1']; 
                      }
                      ?>"  type="email" id="Email" name="Email" placeholder="Email"   class="Input" pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"  title="please enter email">
                       
                       
                        
                        
                        <label style="font-size: 20px" for="pass" class="top">Password : </label>  
                        <input value="<?php if(isset($_SESSION['password1'])){
                      echo $_SESSION['password1']; 
                      }
                      ?>" name="password"  type="text"  class="Input" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="pass" placeholder="password to you" class="Input" value="2016Qwee" title="should be at least one number, one lowercase and one uppercase letter
    and  at least 8 characters">
                        
                           <label style="font-size: 20px" for="pass" class="top">Balance : </label>  
                           <p style="color: white"   name="password"  type="text" class="Input" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="pass" placeholder="password to you" class="Input" value="" title="should be at least one number, one lowercase and one uppercase letter
    and  at least 8 characters">
                      ...
                      ?>
                        ...
                        <label style="font-size: 20px" for="Type"  class="top">Type: </label>  
                        <input style="color:black" value="<?php if(isset($_SESSION['type1'])){
                      echo $_SESSION['type1']; 
                      }
                      ?>" type="text" name="type"id="Firstname" title="please enter your type" placeholder="type"  class="Input" pattern="{2,10}"/>
                       
                        
                        <label style="font-size: 20px" for="ssn"  class="top">Ssn: </label>  
                        <input value="<?php if(isset($_SESSION['ssn1'])){
                      echo $_SESSION['ssn1']; 
                      }
                      ?>" type="text" name="ssn" id="Firstname" title="please enter your ssn" placeholder="ssn"  class="Input" pattern="{14}">
                          
                        <label style="font-size: 20px" for="Firstname"  class="top">Salary: </label>  
                        <input style="color:black" value="<?php if(isset($_SESSION['salary1'])){
                      echo $_SESSION['salary1']; 
                      }
                      ?>" type="text" name="salary" id="Firstname" title="please enter your salary" placeholder="salary"  class="Input" pattern="{2,10}"/>
                       
                        
                       <label style="font-size: 20px" for="Firstname"  class="top">Age: </label>  
                        <input value="<?php if(isset($_SESSION['age1'])){
                      echo $_SESSION['age1']; 
                      }
                      ?>" type="text" name="Age"id="Firstname" title="please enter your age" placeholder="age"  class="Input" pattern="{2,10}">
                     
                        <label style="font-size: 20px" class="top"for="BD" >Birth date : </label>  
                         <input value="<?php if(isset($_SESSION['birthdate1'])){
                      echo $_SESSION['birthdate1']; 
                      }
                      ?>" name="Birthdate" type="date" title="please enter your birthdate" id="BD"  class="Input" class="Input" placeholder="yyyy-mm-dd" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" >
                  
                         <label style="font-size: 20px" for="Firstname"  class="top">Work Hours: </label>  
                        <input style="color:black" value=" <?php if(isset($_SESSION['workhours1'])){
                      echo $_SESSION['workhours1']; 
                      }
                      ?>" type="text" name="workhours"id="Firstname" title="please enter your workhours" placeholder="workhours"  class="Input" pattern="{2,10}"/>
                        ...
                        <input id="info" style="margin-right: 300px;" name ="submit" type="submit" value=" Update ">	  
                      </div>
                             </form>
