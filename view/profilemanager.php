...
<html lang="en">
  ...
  $result = $object->query($query);
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h2 id="in"> Personal Information </h2> 
                   <hr class="in2">
                  <div id="prof">
                      <form  method="post" name="FirstForm" action="../controller/Updatemanagerprofilecontroller.php">
                    <div  id="proff"> 
                      ...
                      ?>" type="text" name="FirstName"id="Firstname" title="please enter your First name" placeholder="First Name"  class="Input" pattern="[A-Za-z]{3,}">
    ...
    and  at least 8 characters">
                        ...
                        <p style="color:white" value=" " type="text" name="city"id="Firstname" title="" placeholder="" autofocus required class="Input" pattern="{14}">
                      ...
                      ?>
                        ...
                        <input style="color:white" value=" <?php if(isset($_SESSION['salary'])){
                      echo $_SESSION['salary']; 
                      }
                      ?>" type="text" name="salary"id="Firstname" title="" placeholder="" autofocus required class="Input" pattern="{2,10}"/>
                      ...
                      ?>" type="text" name="Age"id="Firstname" title="" placeholder="" autofocus required class="Input" pattern="{2,10}">
                      ...
                      ?>" name="Birthdate" type="date" id="BD" autofocus required class="Input" class="Input" placeholder="yyyy-mm-dd" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" >
                       ...
                       <label style="font-size: 20px" for="Firstname"  class="top">Work Hours: </label>  
                        <input style="color:white" value=" <?php if(isset($_SESSION['workhours'])){
                      echo $_SESSION['workhours']; 
                      }
                      ?>" type="text" name="workhours"id="Firstname" title="" placeholder="" autofocus required class="Input" pattern="{2,10}"/>
