          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                      ...
                      <h2 style="margin-left:180px " id="in"> Add New Guest Information </h2> 
                   <hr class="in2">
                  <div id="prof">
                      <form  method="post" name="FirstForm" action="../controller/registreceptcontroller.php" onsubmit="alert('Thanks for Adding');">
                    <div  id="proff"> 
